                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            @if($cart->webinar->getDiscount($cart->ticket) > 0)
                                                <span class="text-primary font-weight-bold">{{ handlePrice($cart->webinar->price - $cart->webinar->getDiscount($cart->ticket)) }}</span>
                                                <span class="off ml-15">{{ handlePrice($cart->webinar->price) }}</span>
                                            @else
                                                <span class="text-primary font-weight-bold">{{ handlePrice($cart->webinar->price) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="navbar-cart-info">
                                        ...
                                        <div class="price mt-10">
                                            <span class="text-primary font-weight-bold">
                                                @if(!empty($cart->reserve_meeting_id))
                                                    {{ handlePrice($cart->reserveMeeting->meeting->amount) }}
                                                @endif
                                            </span>
                                        </div>
                                    </div>
