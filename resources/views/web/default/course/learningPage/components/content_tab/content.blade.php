        ...
        <div class="tab-item-info mt-15">
            ...
            <div class="d-flex align-items-center justify-content-between mt-15">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" id="readToggle{{ $type }}{{ $item->id }}" data-item-id="{{ $item->id }}" data-item="{{ $type }}_id" value="{{ $item->webinar_id }}" class="js-passed-lesson-toggle custom-control-input" @if(!empty($item->learningStatus)) checked @endif>
