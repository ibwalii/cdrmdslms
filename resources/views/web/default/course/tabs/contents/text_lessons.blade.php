            ...
            @foreach($textLessons as $textLesson)
                <div class="accordion-row rounded-sm border mt-20 p-15">
                    <div class="d-flex align-items-center justify-content-between" role="tab" id="textLessons_{{ $textLesson->id }}">
                        <div class="d-flex align-items-center" href="#collapseTextLessons{{ $textLesson->id }}" aria-controls="collapseTextLessons{{ $textLesson->id }}" data-parent="#textLessonsAccordion" role="button" data-toggle="collapse" aria-expanded="true">
                        ...
                        <i class="collapse-chevron-icon" data-feather="chevron-down" height="20" href="#collapseTextLessons{{ !empty($textLesson) ? $textLesson->id :'record' }}" aria-controls="collapseTextLessons{{ !empty($textLesson) ? $textLesson->id :'record' }}" data-parent="#textLessonsAccordion" role="button" data-toggle="collapse" aria-expanded="true"></i>
                    </div>
