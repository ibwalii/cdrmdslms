<div class="row">
    <div class="col-12">
        <div class="accordion-content-wrapper" id="quizzesAccordion{{ !empty($tagId) }}" role="tablist" aria-multiselectable="true">
            @foreach($quizzes as $quiz)
                <div class="accordion-row rounded-sm border mt-20 p-15">
                    <div class="d-flex align-items-center justify-content-between" role="tab" id="quiz_{{ $quiz->id }}">
                        <div class="d-flex align-items-center" href="#collapseQuiz{{ !empty($tagId) }}{{ $quiz->id }}" aria-controls="collapseQuiz{{ !empty($tagId) }}{{ $quiz->id }}" data-parent="#quizzesAccordion{{ !empty($tagId) }}" role="button" data-toggle="collapse" aria-expanded="true">
                        ...
                        <i class="collapse-chevron-icon" data-feather="chevron-down" height="20" href="#collapseQuiz{{ !empty($tagId) }}{{ !empty($quiz) ? $quiz->id :'record' }}" aria-controls="collapseQuiz{{ !empty($tagId) }}{{ !empty($quiz) ? $quiz->id :'record' }}" data-parent="#quizzesAccordion{{ !empty($tagId) }}" role="button" data-toggle="collapse" aria-expanded="true"></i>
                    </div>
