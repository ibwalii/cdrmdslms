...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Section::updateOrCreate(['id' => 1700], ['name' => 'admin_agora_history', 'caption' => 'Agora history']);
        Section::updateOrCreate(['id' => 1701], ['name' => 'admin_agora_history_list', 'section_group_id' => 1700, 'caption' => 'Agora history lists']);
